    ...
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-left text-white px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="max-w-3xl">
          <h1 
            className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-6 drop-shadow-lg uppercase tracking-normal leading-[0.8] sm:leading-[0.78] lg:leading-[0.75]"
          >
