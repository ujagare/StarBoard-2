    ...
    <section id="founder" className="relative py-12 bg-deepblue text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-8 flex flex-col items-center">
          <h2 className="font-serif text-4xl sm:text-6xl md:text-7xl lg:text-8xl text-gold mb-4 uppercase tracking-normal text-center leading-[1.15] sm:leading-[0.85]">
        ...
        <figcaption className="mt-10 flex flex-col items-center md:items-end md:pr-10">
          ...
          <cite className="font-serif text-2xl md:text-3xl lg:text-4xl text-white not-italic">Sandesh Rolston</cite>
