    ...
    <section id="services" ref={sectionRef} className="py-24 bg-deepblue text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div 
            ref={imageRef} 
            className="relative h-[400px] lg:h-[500px] xl:h-[750px] w-full rounded-sm overflow-hidden order-2 lg:order-1 shadow-2xl"
          ...
          <div className="space-y-8 order-1 lg:order-2">
            <h2 className="font-serif text-4xl md:text-5xl leading-tight">
              <AnimatedText text="Premium" /> <span className="text-gold italic"><AnimatedText text="Services" /></span>
            </h2>
